...
/*
  //other light resources, enable them when necessary
...
reshape(int width, int height)
{
  ...
  gluLookAt(0.0, 0.0, 100, //camera pos
...
/*
  ...
  gluLookAt(0.0, 80, 0.1, // camera pos, z must be >0, otherwise inside floor
  0.0, 0, 0.0,      // center is moved along y+, s.t. the floor is lowered
  0.0, 1.0, 0.0);      // up is in postivie Y direction
*/
