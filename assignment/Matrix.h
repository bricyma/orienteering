...
public:
  ...
  inline EID GetEID(void){ return eid; }
  ...
  inline bool GetMatchedFlag(void){ return matched_flag; }
  inline void SetMatchedFlag(bool _matched_flag){ matched_flag = _matched_flag;}

  inline bool GetAdmissibleFlag(void){ return admissible_flag; }
...
public:
  ...
  inline VID GetVID(void){ return vid; }
  inline void SetVID(VID _vid){ vid = _vid; }

  inline string GetObj(void){ return obj; }
  inline void SetObj(string _obj){ obj = _obj; }

  inline double GetLabel(void){ return label; }
  inline void SetLabel(double _label){ label = _label; }

  inline bool GetMatched(void){ return matched; }
  inline void SetMatched(bool _matched){ matched = _matched; }

  inline bool GetColored(void){ return colored; }
  inline void SetColored(bool _colored){ colored = _colored; }

  inline bool GetVisited(void){ return visited; }
